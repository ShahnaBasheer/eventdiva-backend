...
class CustomerController {
    constructor(userService, customerService, eventPlannerService, venueVendorService, notificationService) {
        ...
        // Customer Signup
        this.signupCustomer = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const errors = (0, express_validator_1.validationResult)(req);
            if (!errors.isEmpty()) {
                throw new customError_1.BadRequestError("Validation failed");
            }
            const { email, password, firstName, lastName } = req.body;
            const response = yield this.userService.signupUser({ email, password, firstName, lastName }, important_variables_1.UserRole.Customer);
            if (response) {
        ...
        this.verifyOtp = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const isVerified = yield this.userService.otpVerification(email, otp, important_variables_1.UserRole.Customer);
            if (isVerified) {
        ...
        this.resendOtp = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.userService.resendOtp(email, important_variables_1.UserRole.Customer);
        ...
        // Customer Login
        this.loginCustomer = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const { email, password } = req.body;
            const errors = (0, express_validator_1.validationResult)(req);
            if (!errors.isEmpty()) {
                throw new customError_1.BadRequestError("Validation failed");
            }
            const data = yield this.userService.loginUser(email, password, important_variables_1.UserRole.Customer);
            if (data) {
        ...
        this.signinWithGoogle = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.userService.verifyWithGoogle(idToken, important_variables_1.UserRole.Customer);
            if (data) {
                res.cookie(process.env.CUSTOMER_REFRESH, data.refreshToken, {
                    httpOnly: true,
                    secure: true,
...
const customerController = new CustomerController(dependencyContainer_1.userService, dependencyContainer_1.customerService, dependencyContainer_1.eventPlannerService, dependencyContainer_1.venueVendorService, dependencyContainer_1.notificationService);
