...
router.get('/', customer_controller_1.default.getCustomerHome);
router.get('/home', customer_controller_1.default.getCustomerHome);
router.get('/contact', customer_controller_1.default.getContactPage);
router.get('/about', customer_controller_1.default.getAboutPage);
router.get('/vendors/event-planners', customer_controller_1.default.getAllEventPlanners);
router.get('/vendors/event-planners/:slug', common_controller_1.default.getEventPlanner);
router.get('/vendors/venues', customer_controller_1.default.getAllVenues);
router.get('/vendors/venues/:slug', common_controller_1.default.getVenue);
...
router.get('/notifications', customer_controller_1.default.getNotifications);
router.patch('/notifications/read', customer_controller_1.default.changeReadStatus);
router.delete('/notifications/delete/:id', customer_controller_1.default.deleteNotification);
