...
router.get('/notifications', vendor_controller_1.default.getNotifications);
router.get('/unread-messages', socket_controller_1.default.getUnreadAllMessages);
router.patch('/notifications/read', vendor_controller_1.default.changeReadStatus);
router.delete('/notifications/delete/:id', vendor_controller_1.default.deleteNotification);
