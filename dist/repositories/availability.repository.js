...
class AvailabilityRepository extends base_repository_1.default {
    constructor() {
        super(availabilityModel_1.default);
    }
    findOneByFilter(filter) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield availabilityModel_1.default.findOne(Object.assign({}, filter))
                .populate({
